                ...
                <form name="usr_plan_purchase_frm" id="usr_plan_purchase_frm" method="post" action="javascript:void(0);">
                    ...
                    <input type="hidden" name="selected_plan" id="selected_plan" value="">
                        ...
                        <div class="row">
                            <div class="col-sm-9">
                                <div class="form-group">
                                    <input type="text" name="membership_coupon" id="new_membership_coupon" class="form-control input-lg" value="" autocomplete="off" placeholder="<?php _e('Enter coupon code', THEME_TEXTDOMAIN); ?>" />
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <button class="btn btn-cs ladda-button btn-lg" data-style="expand-right" id="usr_membership_coupon_sbmt" type="submit"><?php _e('Apply', THEME_TEXTDOMAIN); ?></button>
                            </div>
                        </div>
